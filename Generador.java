public class Generador extends JFrame {
	...
	public Generador() throws ClassNotFoundException, SQLException {
		...
		fondo = getClass().getResource("/Imagenes/fondoSistema.jpg"); //Imagen de fondo
	...
	private void laminaSuperior() throws ClassNotFoundException, SQLException {
		//Interfaz grafica panel superior.
		...
		listaTrabajadores = new JComboBox();//Crea un comboBox
		...
		listaTrabajadores.setFont(new Font("Verdana", Font.PLAIN, 12)); //Fuentas para el combo.
		...
		ConectarBBDD_Mysql.Desconexion();//Conecta a la base de datos.
	...
	//Devuelve un string con la fecha en formato dia mes y año
	...
	//Metodo para obtener el Número de la semana.
